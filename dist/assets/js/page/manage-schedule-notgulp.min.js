  ...
  $("body").on("click", ".js-delete-row", function () {
    ...
    $(".js-rp .js-row").each(function () {
      ...
      $(this)
        ...
        .each(function () {
          name_input = $(this).attr("name");
          new_name_input = name_input.replace(
            "_" + thisRow + "_",
            "_" + i + "_"
          );
          id_input = $(this).attr("id");
...
function addNewSchedule() {
  ...
  $(".js-create-select").on("change", function () {
    var option = $("option:selected", this),
      ...
      el_ttl = $('.js-custom-title');
    // el_content.html("").append($.parseHTML(data_content));
    el_level.find("option[value=" + data_level + "]").prop("selected", true);
    el_ttl.val(data_ttl);
    el_content.val(data_content);
  });

  $('.js-custom-title, .js-lesson-content').on('input', function(){
    $(".js-create-select").val('');
  })
  $(".js-lesson-level").on("change", function () {
    $(".js-create-select").val('');
  })
...
function validateCreate() {
  $(".js-start-time").on("change", function () {
    ...
    if (
      $(".js-end-time").val() == "" ||
      $(".js-end-time")[0].selectedIndex <= selected
    ) {
      $(".js-end-time option:nth-child(" + (selected + 2) + ")").prop(
        "selected",
        "true"
      );
    }
