...
$studio_url = $_SERVER['REQUEST_SCHEME'] .'://'. $_SERVER['HTTP_HOST'].'/'.explode( '/', explode('?', $_SERVER['REQUEST_URI'], 2)[0] )[1].'/'.explode('/', explode('?', $_SERVER['REQUEST_URI'], 2)[0])[2].'/'.explode('/', explode('?', $_SERVER['REQUEST_URI'], 2)[0])[3].'/';

// var_dump($cur_url);
// var_dump($_SERVER['REQUEST_SCHEME']);
// // var_dump(explode('/', explode('?', $_SERVER['REQUEST_URI'], 2)[0]));
// var_dump(explode('/', explode('?', $_SERVER['REQUEST_URI'], 2)[0]))[1];
// var_dump(explode('/', explode('?', $_SERVER['REQUEST_URI'], 2)[0]))[2];
// var_dump($studio_url);
